...
async def handle_health(request):
    ...
    health_page_html = HEALTH_PAGE.format(
        uptime=uptime,
        total_rolls=stats['total_rolls'],
        active_users=stats['active_users']
    )

    return web.Response(text=health_page_html, content_type='text/html')
...
async def handle_stats(request):
    ...
    users_page_html = STATS_PAGE.format(
        uptime=uptime,
        total_rolls=stats['total_rolls'],
    ...
    return web.Response(text=users_page_html, content_type='text/html')
...
async def handle_suspended(request):
    ...
    try:
        ...
        suspended_page_html = SUSPENDED_PAGE.format(
            suspended_count=len(suspended_users),
            users_list=users_html
        )
        
        return web.Response(text=suspended_page_html, content_type='text/html')
    except Exception as e:
