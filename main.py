...
def init_database():
    ...
    try:
        ...
        # Add last_fruit column if it doesn't exist (Performance optimization for dashboard)
        try:
        ...
        # Backfill last_fruit cache if needed
...
async def handle_stats(request):
    ...
    for user in users_sorted:
        ...
        # Use cached last fruit (Performance optimization: avoids N+1 database queries)
