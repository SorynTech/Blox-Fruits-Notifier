...
def init_database():
    ...
    try:
        ...
        # Add last_fruit column if it doesn't exist (Bolt optimization)
        try:
        ...
        # Backfill last_fruit cache (Bolt optimization)
        ...
        ''')
        logger.info("✅ 'last_fruit' backfill complete")
...
async def handle_stats(request):
    ...
    for user in users_sorted:
        ...
        # Get their last fruit from the user object (Bolt optimization: eliminated get_user_rolls N+1 query)
