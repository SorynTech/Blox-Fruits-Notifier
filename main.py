...
async def handle_stats(request):
    ...
    for user in users_sorted:
        ...
        # Sanitize user-controlled data for XSS prevention
    ...
    # Rename 'html' to 'response_html' to avoid shadowing the 'html' module
            ...
            for user in suspended_users:
                ...
                <div class="user-card">
                    ...
                    <div style="margin-top: 8px; color: #fbbf24; font-weight: bold;">
                        Reason: {safe_reason if safe_reason else 'No reason provided'}
                    </div>
                </div>
                """
        else:
